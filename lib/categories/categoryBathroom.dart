...
class CategoryBathroom extends StatelessWidget {
  const CategoryBathroom({super.key});
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              ProductView("bathrooms/${data[index]["id"]}", "${data[index]["data"]["name"]}")),
                    );
                  },
                  child: Card(
