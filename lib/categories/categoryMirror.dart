...
class CategoryMirror extends StatelessWidget {
  const CategoryMirror({super.key});

  @override
  Widget build(BuildContext context) {
    CollectionReference products =
        FirebaseFirestore.instance.collection('mirrors');

    return Scaffold(
      appBar: AppBar(
        title: const Text("Ogledala"),
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              ProductView("mirrors/${data[index]["id"]}", "${data[index]["data"]["name"]}")),
                    );
                  },
                  child: Card(
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                                fit: BoxFit.fill,
                                image:
                                    AssetImage(data[index]['data']['image'])),
                          ),
                        ),
                        Column(
