...
class CategoryRack extends StatelessWidget {
  const CategoryRack({super.key});

  @override
  Widget build(BuildContext context) {
    CollectionReference products =
        FirebaseFirestore.instance.collection('racks');

    return Scaffold(
      appBar: AppBar(
        title: const Text("Regali"),
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              ProductView("racks/${data[index]["id"]}", "${data[index]["data"]["name"]}")),
                    );
                  },
                  child: Card(
