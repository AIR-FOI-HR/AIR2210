...
class CategorySofa extends StatelessWidget {
  const CategorySofa({super.key});

  @override
  Widget build(BuildContext context) {
    CollectionReference products =
        FirebaseFirestore.instance.collection('sofas');

    return Scaffold(
      appBar: AppBar(
        title: const Text("Sofe"),
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              ProductView("sofas/${data[index]["id"]}", "${data[index]["data"]["name"]}")),
                    );
                  },
                  child: Card(
