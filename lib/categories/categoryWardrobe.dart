...
class CategoryWardrobe extends StatelessWidget {
  const CategoryWardrobe({super.key});
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              ProductView("wardrobes/${data[index]["id"]}", "${data[index]["data"]["name"]}")),
                    );
                  },
                  child: Card(
